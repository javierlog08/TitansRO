// AuraSet (By Dastgir Pojee(dastgirpojee@rocketmail.com) / Hercules) Plugin
...
HPExport struct hplugin_info pinfo = {	//[Dastgir Pojee/Hercules]
	"AuraSet",		// Plugin name
...
/*==========================================
* Aura [Dastgir Pojee/Hercules]
*------------------------------------------*/

BUILDIN(aura){
	int aura, aura1, aura2;
	...
	pc_setglobalreg(sd, script->add_str("USERAURA"), aura);
	pc_setglobalreg(sd, script->add_str("USERAURA1"), aura1);
	pc_setglobalreg(sd, script->add_str("USERAURA2"), aura2);
...
void clif_getareachar_unit_AuraPost(struct map_session_data* sd, struct block_list *bl) {	//[Dastgir Pojee/Hercules]
//	struct unit_data *ud;
	struct view_data *vd;
...
int status_change_start_postAura(int retVal,struct block_list *src, struct block_list *bl, enum sc_type type, int rate, int val1, int val2, int val3, int val4, int tick, int flag) {	//[Dastgir Pojee/Hercules]
...
int status_change_end_postAura(int retVal, struct block_list* bl, enum sc_type type, int tid, const char* file, int line) {	//[Dastgir Pojee/Hercules]
...
HPExport void plugin_init(void) {	//[Dastgir Pojee/Hercules]
